...
(function(ns) {
	...
	function Range(dom) {
		...
		function _traverse(how) {
			...
			// ascend the ancestor hierarchy until we have a main parent.
...
(function(tinymce) {
	tinymce.dom.RangeUtils = function(dom) {
		...
		this.walk = function(rng, callback) {
			...
			// Find main ancestor and end points
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			mceInsertLink : function(command, ui, value) {
				...
				// Spaces are never valid in URLs and it's a very main mistake for people to make so we fix it here.
