...
var dsv = function(delimiter) {
  ...
  function parseRows(text, f) {
    ...
    function token() {
      ...
      // main case: find next delimiter or newline
      while (I < N) {
        var k = 1;
        c = text.charCodeAt(I++);
        if (c === 10) eol = true; // \n
...
var tree = function() {
  ...
  // contours of the left and right subtree up to the highest main level. The
...
var clipCircle = function(radius, delta) {
  var cr = cos$1(radius),
      smallRadius = cr > 0,
      notHemisphere = abs(cr) > epsilon$4; // TODO optimise for this main case
