...
def trainNB0(trainMatrix,trainCategory):
    ...
    pAbusive = sum(trainCategory)/(float(numTrainDocs)*3)
    pBbusive = sum(trainCategory)/(float(numTrainDocs)*3)
    p0Num = ones(numWords); p1Num = ones(numWords); p2Num = ones(numWords)     #change to ones()
    p0Denom = 3.0; p1Denom = 3.0 ; p2Denom = 3.0                      #change to 2.0
    ...
    return p0Vect,p1Vect,p2Vect,pAbusive,pBbusive
